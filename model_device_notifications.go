...
type DeviceNotifications struct {
	EMailFlag               bool                                    `json:"E_Mail_Flag,omitempty"`
	EMailAddress            string                                  `json:"E_Mail_Address,omitempty"`
	EMailTimeIntervalMin    int32                                   `json:"E_Mail_TimeInterval_Min,omitempty"`
	WLDeviceFlag            bool                                    `json:"WL_Device_Flag,omitempty"`
	WLDeviceEmailAddress    bool                                    `json:"WL_Device_Email_Address,omitempty"`
	WLDeviceTimeIntervalMin int32                                   `json:"WL_Device_TimeInterval_Min,omitempty"`
	PagerFlag               bool                                    `json:"Pager_Flag,omitempty"`
	...
	PhoneFlag               bool                                    `json:"Phone_Flag,omitempty"`
	...
	NotificationGroups      []DeviceNotificationsNotificationGroups `json:"Notification_Groups,omitempty"`
}
